...
void AParaTestCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AParaTestCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AParaTestCharacter::Look);
	}
	else
	{
...
void AParaTestCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AParaTestCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
